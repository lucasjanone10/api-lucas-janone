...
app.post('/api/gerar-roteiro', async (req, res) => {
    try {
        ...
        // INJEÇÃO AUTOMÁTICA DE IMAGENS (A prova de falhas)
        // O código acha os títulos "Dia 1", "Dia 2" e injeta a foto à força para a IA não errar
        let imageCounter = 1;
        ...
        // CSS ATUALIZADO (Margens corrigidas e texturas)
        const htmlTemplate = `
        <!DOCTYPE html>
        <html lang="pt-BR">
        <head>
            ...
            <style>
                ...
                @page { margin: 0; } /* Zera as margens da impressora para a capa ocupar tudo */
                ...
                .content-wrapper { padding: 40px 65px; } /* Respiro lateral das páginas internas */
                
                /* CORREÇÃO DAS MARGENS (Espaçamento do Topo) */
                h2 { 
                    color: #0f172a; font-size: 28px; border-bottom: 3px solid #FF6B35; 
                    padding-bottom: 12px; margin-bottom: 20px; margin-top: 0;
                    page-break-before: always; 
                    padding-top: 70px; /* Isso garante que não vai colar no teto da folha */
                }
                ...
                /* FOTOS DOS DIAS (Agora inseridas à força) */
        ...
        // Timeout longo para garantir que todas as fotos carreguem (networkidle0 é a chave aqui)
