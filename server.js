...
app.post('/api/gerar-roteiro', async (req, res) => {
    try {
        ...
        let imageCounter = 1;
        const destinoLimpo = encodeURIComponent(destino.trim().split(' ')[0]); 
        ...
        // CORREÇÃO MESTRE: Trocamos 'networkidle2' por 'load' e desligamos o timeout limitador!
        await page.setContent(htmlTemplate, { waitUntil: 'load', timeout: 0 });
        
        // Script focado apenas nas fotos reais, com limite de 5 segundinhos para cada
