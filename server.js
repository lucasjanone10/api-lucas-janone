    ...
    try {
        ...
        <head>
            ...
            <style>
                ...
                h3 { font-family: 'Inter', sans-serif; color: #FF6B35; font-size: 18px; text-transform: uppercase; letter-spacing: 1.5px; margin-top: 40px; margin-bottom: 15px; border-bottom: 1px solid #e2e8f0; padding-bottom: 8px; }
        ...
        const browser = await puppeteer.launch({ 
            headless: 'new',
            protocolTimeout: 120000, // <-- A CORREÇÃO DE OURO (120 segundos de paciência)
        ...
        // Timeout longo e networkidle2 para evitar travamentos em conexões extras das imagens
        await page.setContent(htmlTemplate, { waitUntil: 'networkidle2', timeout: 120000 });
        
        // Avaliação mais flexível e blindada
        await page.evaluate(async () => {
            ...
            await Promise.all(images.map(img => {
                ...
                return new Promise((resolve) => {
                    ...
                    img.addEventListener('error', resolve); // Ignora erros pra não travar tudo
                    setTimeout(resolve, 10000); // 10s limite rígido por imagem pra não estourar o robô
                });
            }));
        });
